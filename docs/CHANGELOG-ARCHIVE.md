...
**Archive note:** this file holds every CHANGELOG.md entry older than what's kept live in the top-level CHANGELOG.md (moved here during a 2026-07-22 cleanup pass to keep the live file readable) — nothing lost, just relocated. See CHANGELOG.md for current/recent entries.
