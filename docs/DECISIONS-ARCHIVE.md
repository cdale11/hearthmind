...
**Archive note:** this file holds every docs/DECISIONS.md entry older than what's kept live in the top-level file (moved here during a 2026-07-22 cleanup pass to keep the live file readable) — nothing lost, just relocated. See docs/DECISIONS.md for current/recent entries.
